...
*Sprint 4.5–4.7 additions: `integration.google.connected` (sync) + `integration.google.disconnected` (Amendment 006); `workspace.onboarded` (sync, Sprint 4.6); `target.set` (sync) + `target.indexed` (Amendment 008). Sprint 4.8: `website.audit.completed` (sync) + `website.audit.indexed` (Amendment 009). Milestone M4: `outreach.draft.generated` (sync, Amendment 010). The v0.1 catalogue now holds 31 events.*
